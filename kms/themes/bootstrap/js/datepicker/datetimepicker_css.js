...
var StartYear = 1980; //First Year in drop down year selection
...
function RenderCssCal(bNewCal)
{
    ...
    {
        vCalHeader += "<td align='center'><select style='width: 100px;' name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
        for (i = 0; i < 12; i += 1)
        {
            if (i === Cal.Month)
            {
        ...
        vCalHeader += "<td align='center'><select style='width: 100px;' name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
        for (i = StartYear; i <= 2020; i += 1)
        {
            if (i === Cal.Year)
            {
    ...
    else //if not to show time.
    {
        ...
        //close button
        if (UseImageFiles) {
            vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+imageFilesPath+"cal_close.gif' width='16px' height='14px' alt='Close' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
        }
        else {
