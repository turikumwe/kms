...
$this->renderPartial('../_ToolsMenu', array('active' => 'none', 'userOption' => true, 'id' => $model->UserID, 'user' => $model));
?>
<div class="span9">
...
<div id="reset_password" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Reset Password <em></em></h3>
    </div>
    <div class="modal-body">
        <form method="post" action="<?php echo Yii::app()->createUrl("/admin/user/resetPassword") ?>" id="verticalForm" class="well form-vertical" >
