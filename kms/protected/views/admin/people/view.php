...
$this->renderPartial('../_PeopleMenu', array('active' => 'none', 'editAction' => true, 'id' => $model->IndividualID));
?>
<div class="span10">
                        ...
                        <tbody class="detail-data">
                            ...
                            <?php if (count($contacts) > 0) { ?>
                                ...
                                foreach ($contacts as $contact) {
                                    ...
                                    . '<a href="' . Yii::app()->createUrl("/admin/people/delCont", array("id" => $contact->SocialNetworkID)) . '" rel="tooltip" class="delete" data-original-title="Delete"><i class="icon-trash"></i></a></div></td></tr>';
                                }
                                ?>
 ...
 ->createUrl("/admin/people/get",array("id"=>$data->DocumentID)))',
                                'type' => 'raw'),
                            ...
                            array(
                                ...
                                'buttons' => array(
                                    'delete' => array(
                                        'url' => 'Yii::app()->createUrl("/admin/people/del",array("id"=>$data->DocumentID))', // the PHP expression for generating the URL of the button
                ...
                <?php if (count($documentCategories) > 0) { ?>
                    <div class="modal-body">
                        ...
                        $form = $this->beginWidget('CActiveForm', array(
                            'id' => 'document-form',
                            'action' => Yii::app()->createUrl("/admin/people/addDocument"),
...
<div id="add_contact" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <form action="<?php echo Yii::app()->createUrl("/admin/people/addContact"); ?>" id="add_contact" method="POST">
