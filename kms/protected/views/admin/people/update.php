...
$this->breadcrumbs = array(
    ...
    $model->LastName => array('view', 'id' => $model->IndividualID),
    'Update',
);
$this->renderPartial('../_PeopleMenu', array('active' => 'editPeople', 'editAction'=>true, 'id'=>$model->IndividualID));
?>
...
<div class="span10">
    ...
    <?php echo $this->renderPartial('../../default/_Individualform', array('model' => $model, 'statusList' => $statusList, 
